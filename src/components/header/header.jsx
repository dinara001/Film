...
export default function Header({ data }) {
  ...
  const toggeleSearch = viewSearch ? 'view-search' : ''
    ...
    <div className='header'>
      ...
      <div className='cart-btn-wrapper'>
        <div className='search-block'>
          <input value={search} onChange={(e) => setSearch(e.target.value)} className={`input-search ${toggeleSearch}`} type='search' placeholder='Введите запрос' />
          {
